...
<head>
    ...
    <style>
        ...
        .logo img {
            margin-right: 10px; /* Add some space between logo text and image */
            max-height: 70px; /* Set maximum height for the image */
        }
        .navbar a {
            color: #1a237e; /* Dark Blue */
        ...
        .background {
            background-image: url('90614.jpg'); /* Replace 'background-image.jpg' with the path to your background image */
        ...
        input[type="submit"]:hover {
            background-color: #121858; /* Darker Blue on hover */
        }
    </style>
</head>
